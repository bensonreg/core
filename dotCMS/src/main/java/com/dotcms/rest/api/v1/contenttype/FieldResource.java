...
public class FieldResource implements Serializable {
  ...
  public final Response getContentTypeFields(
	@PathParam("typeId") final String typeId, @Context final HttpServletRequest req
  ) {
    ...
    try {
    	List<Field> fields = fapi.byContentTypeId(
    		tapi.find(typeId).id()
    	);

    	response = Response.ok(new ResponseEntityView(
    		new JsonFieldTransformer(fields).mapList()
    	)).build();
  ...
  @Produces({MediaType.APPLICATION_JSON, "application/javascript"})
  public Response createContentTypeField(
	@PathParam("typeId") final String typeId, final String fieldJson, @Context final HttpServletRequest req
    ...
    try {
    	...
    	response = Response.ok(new ResponseEntityView(
    		new JsonFieldTransformer(field).mapObject()
    	)).build();
  ...
  public Response getContentTypeFieldById(
	@PathParam("typeId") final String typeId, @PathParam("fieldId") final String fieldId, @Context final HttpServletRequest req
  ) throws DotDataException, DotSecurityException {
  ...
  @NoCache
  @Produces({MediaType.APPLICATION_JSON, "application/javascript"})
  public Response getContentTypeFieldByVar(
	@PathParam("typeId") final String typeId, @PathParam("fieldVar") final String fieldVar, @Context final HttpServletRequest req
  ) throws DotDataException, DotSecurityException {
  ...
  @NoCache
  @Produces({MediaType.APPLICATION_JSON, "application/javascript"})
  public Response deleteContentTypeFieldByVar(
	@PathParam("typeId") final String typeId, @PathParam("fieldVar") final String fieldVar, @Context final HttpServletRequest req
  ) throws DotDataException, DotSecurityException {
